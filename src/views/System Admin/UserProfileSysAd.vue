        ...
        <div v-else class="profile-container">
          <div class="profile-header">
            ...
            <div class="profile-info">
              ...
              <span class="role-badge system-admin">{{ userData.role }}</span>
  ...
  methods: {
    ...
    async updateProfile() {
      try {
        ...
        // For normal users, update via API
        ...
        // Update session storage and local storage if they exist
        if (sessionStorage.getItem('user')) {
          const sessionUser = JSON.parse(sessionStorage.getItem('user'));
          sessionUser.full_name = updatedUser.full_name;
        ...
        if (localStorage.getItem('user')) {
          ...
          localUser.full_name = updatedUser.full_name;
        ...
        if (approvedUsersJSON) {
          try {
            ...
            // Find and update the user in the approvedUsers list
            const updatedApprovedUsers = approvedUsers.map(u => {
              if (u.id === this.userData.id || u.email === updatedUser.email) {
    ...
    getPermissionsByRole(role) {
      switch(role) {
        ...
        case 'Academic Coordinator':
          return 'Full Scheduling Control';
        case 'Lab InCharge':
